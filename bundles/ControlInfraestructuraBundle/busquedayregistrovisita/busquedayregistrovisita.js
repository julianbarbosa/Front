saul.config(["$stateProvider",
    function ($stateProvider) {
        $stateProvider.state("busquedayregistrovisita-controlinfraestructura", {
            url: "/controlinfraestructura/busquedayregistro",
            views: {
                "main": {
                    controller: "BusquedayRegistroVisitaControlInfraestructuraCtrl",
                    templateUrl: "../bundles/ControlInfraestructuraBundle/busquedayregistrovisita/busquedayregistrovisita.tpl.html"
                }
            }
        });
    }
]).controller("BusquedayRegistroVisitaControlInfraestructuraCtrl", ["$scope", "$http", "Licencia", "LoadingOverlap", "$stateParams", "root",
    function ($scope, $http, LicenciaAll, LoadingOverlap, $stateParams, root) {
        ...
        $scope.headers = [
            ...
            { type: 'text', name: 'asignacion', name2: '', title: 'Nro Asignacion', header_align: 'text-center', body_align: 'text-center', sorting: 'sorting', input: false, width: '5%' },
            ...
            { type: 'text', name: 'fecha_asignacion', title: 'Fecha Asignacion', header_align: 'text-center', body_align: 'text-center', input: false, width: '10%' },
        ];
