saul.controller("ModalClienteCtrl", ["$scope", "$uibModalInstance", "identificacion",
    function ($scope, $uibModalInstance, identificacion) {
        ...
        function validateSaveCliente() {
            ...
            if (!usuario.email) {
                validator.email = "Ingrese un email";
            }
            if (!usuario.email_confirm) {
                validator.email_confirm = "Ingrese la confirmación de email";
            }
