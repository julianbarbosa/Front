saul.config(["$stateProvider",
    function ($stateProvider) {
        $stateProvider.state("crear-peticion-lineas-ciudadano", {
            url: "/lineademarcacion/solicitudciudadano",
            views: {
                "main": {
                    controller: "CrearPeticionLineasCiudadanoCtrl as vm",
                    templateUrl: "../bundles/LineasBundle/crearPeticionCiudadano/crearPeticionCiudadano.tpl.html",
                }
            },
        })
    }
]).controller("CrearPeticionLineasCiudadanoCtrl", ["$scope", "root", "NgMap", "urlPlugInNomenclatura", "Barrio", "dsJqueryUtils", "Upload",
    function ($scope, root, NgMap, urlPlugInNomenclatura, Barrio, dsJqueryUtils, Upload) {
        ...
        {            
            ...
            dsJqueryUtils.goTop();
            $scope.peticion.origenRadicacion = 'Ciudadano';
            Upload.upload({
                url: root + 'lineademarcacion/solicitudciudadano',
                data: {
                    data: $scope.peticion,
                    files: files
                }
