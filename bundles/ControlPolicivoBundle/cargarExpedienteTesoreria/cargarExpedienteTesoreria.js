saul.config(["$stateProvider",
    function ($stateProvider) {
        $stateProvider.state("controlpolicivo-cargarexpediente", {
            url: "/tesoreria/cargarexpediente",
            views: {
                "main": {
                    controller: "ControlPolicivoCargarExpedienteCtrl",
                    templateUrl: "../bundles/ControlPolicivoBundle/cargarExpedienteTesoreria/cargarExpedienteTesoreria.tpl.html"
                }
            }
        });
    }
]).controller("ControlPolicivoCargarExpedienteCtrl", ["root","$scope", "$http", "$uibModal", "ComparendoExpediente", "$filter", "$stateParams", "root", "AnularPedagogiasActivas", "LoadingOverlap", "Upload", "ComportamientoContrario",
    function (root, $scope, $http, $uibModal, Comparendo, $filter, $stateParams, root, AnularPedagogiasActivas, LoadingOverlap, Upload, ComportamientoContrario) {
        ...
        $scope.setEstadoRevision = function() {
            ...
            console.log("estadoRevisión=>",$scope.estadoRevision);
            console.info("permisos",$scope.permisos);
		}
