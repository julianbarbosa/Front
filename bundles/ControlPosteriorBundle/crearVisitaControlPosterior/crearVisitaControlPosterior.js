saul.config(["$stateProvider",
    function ($stateProvider) {
        $stateProvider.state("crearvisita-controlposterior", {
            url: "/controlposterior/crearsolicitud",
            views: {
                "main": {
                    controller: "CrearVisitaControlPosteriorCtrl",
                    templateUrl: "../bundles/ControlPosteriorBundle/crearVisitaControlPosterior/crearVisitaControlPosterior.tpl.html"
                }
            }
        });
    }
]).controller("CrearVisitaControlPosteriorCtrl", ["$scope", "$http", "Licencia", "LoadingOverlap", "$stateParams", "root",
    function ($scope, $http, LicenciaAll, LoadingOverlap, $stateParams, root) {
        ...
        $scope.headers = [
            ...
            {type:'text', name: 'identificacionpropietario', name2: '', title: 'Identificación Prop.', header_align: 'text-center', body_align: 'text-center',input: false, sorting: 'sorting', width: '5%'},
            ...
            {type:'text', name: 'nombre_curaduria', title: 'Curaduría', header_align: 'text-center', body_align: 'text-center',input: false, width:'10%'},       
        ];
