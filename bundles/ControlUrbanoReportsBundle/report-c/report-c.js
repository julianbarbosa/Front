saul.config(["$stateProvider",
  function ($stateProvider) {
    $stateProvider.state("control-urbano-report-c", {
      url: "/reportes/report-c/",
      views: {
        "main": {
          controller: "ControlUrbanoReportCCtrl",
          templateUrl: "../bundles/ControlUrbanoReportsBundle/report-c/template.tpl.html"
        }
      }
    });
  }
