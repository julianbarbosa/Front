saul.config(["$stateProvider",
  function ($stateProvider) {
    $stateProvider.state("control-urbano-report-d", {
      url: "/reportes/report-d/",
      views: {
        "main": {
          controller: "ControlUrbanoReportDCtrl",
          templateUrl: "../bundles/ControlUrbanoReportsBundle/report-d/template.tpl.html"
        }
      }
    });
  }
]).controller("ControlUrbanoReportDCtrl", ["$scope", "$http", "root", "UtilForm", "$filter",
  function ($scope, $http, root, UtilForm, $filter) {
    ...
    $scope.headers = [
      ...
      { type: 'text', name: 'numero_de_infracciones', title: 'Infracciones', header_align: 'text-center', body_align: 'text-center', input: false, sorting: 'sorting', width: '7%' },
      { type: 'text', name: 'total_cant_lics', title: 'Numero de Licencias', header_align: 'text-center', body_align: 'text-center', input: false, sorting: 'sorting', width: '7%' },
    ];
    ...
    $scope.actualizarDatos = function () {
      ...
      $http.get(root + 'controlurbano/reports/proyectoslicenciadoscp', { params: params })
