saul.config(["$stateProvider",
  function ($stateProvider) {
    $stateProvider.state("control-urbano-report-general", {
      url: "/reportes/report-general/",
      views: {
        "main": {
          controller: "ControlUrbanoReportGeneralCtrl",
          templateUrl: "../bundles/ControlUrbanoReportsBundle/report-general/template.tpl.html"
        }
      }
    });
  }
]).controller("ControlUrbanoReportGeneralCtrl", ["$scope", "$http", "root", "UtilForm", "$filter",
  function ($scope, $http, root, UtilForm, $filter) {
    ...
    $scope.downloadData = function () {
      ...
      UtilForm.openWith(
        root + "controlurbano/reports/resumenportipovisita",
        'post', $scope.request
      );
    };
    ...
    $scope.headers = [
      { type: 'text', name: 'nombre', title: 'Tipo Visita', header_align: 'text-center', body_align: 'text-center', sorting: 'sorting', input: false, width: '7%' },
      { type: 'text', name: 'pendienteporasignar', title: 'Pendiente por asignar', header_align: 'text-center', body_align: 'text-center', sorting: 'sorting', input: false, width: '7%' },
      { type: 'text', name: 'pendientevisita', title: 'Pendiente por visita', header_align: 'text-center', body_align: 'text-center', input: false, sorting: 'sorting', width: '7%' },
      { type: 'text', name: 'pendienteverificar', title: 'Pendiente por aprobar', header_align: 'text-center', body_align: 'text-center', input: false, sorting: 'sorting', width: '10%' },
      { type: 'text', name: 'preaprobada', title: 'Aprobadas', header_align: 'text-center', body_align: 'text-center', input: false, width: '10%' },
      { type: 'text', name: 'emitido', title: 'Finalizadas', header_align: 'text-center', body_align: 'text-center', input: false, width: '10%' },
    ];
    ...
    $scope.actualizarDatos = function () {
      ...
      $http.get(root + 'controlurbano/reports/resumenportipovisita', { params: params })
