saul.config(["$stateProvider",
  function ($stateProvider) {
    $stateProvider.state("control-urbano-reporte-base", {
      url: "/reportes/reporte-base/",
      views: {
        "main": {
          controller: "ControlUrbanoReporteBaseCtrl",
          templateUrl: "../bundles/ControlUrbanoReportsBundle/reporte-base/template.tpl.html"
        }
      }
    });
  }
]).controller("ControlUrbanoReporteBaseCtrl", ["$scope", "$http", "root", "UtilForm", "$filter",
  function ($scope, $http, root, UtilForm, $filter) {
    ...
    $scope.downloadData = function () {
      ...
      UtilForm.openWith(
        root + "controlurbano/reports/reportetotal",
        'post', $scope.request
      );
    };
    ...
    $scope.headers = [
      { type: 'text', name: 'idvisita', title: 'Consecutivo', header_align: 'text-center', body_align: 'text-center', sorting: 'sorting', input: false, width: '7%' },
      { type: 'text', name: 'v5_direccion_proyecto', title: 'Dirección', header_align: 'text-center', body_align: 'text-center', sorting: 'sorting', input: false, width: '7%' },
      { type: 'text', name: 'v5_nombre_propietario', title: 'Propietario', header_align: 'text-center', body_align: 'text-center', input: false, sorting: 'sorting', width: '7%' },
      { type: 'text', name: 'v5_comuna', title: 'Comuna', header_align: 'text-center', body_align: 'text-center', input: false, sorting: 'sorting', width: '10%' },
      { type: 'text', name: 'visitador', title: 'Visitador', header_align: 'text-center', body_align: 'text-center', input: false, width: '10%' },
      { type: 'text', name: 'fechavisita', title: 'Fecha Visita', header_align: 'text-center', body_align: 'text-center', input: false, width: '10%' },
      { type: 'text', name: 'revisor', title: 'Revisor', header_align: 'text-center', body_align: 'text-center', input: false, width: '10%' },
      { type: 'text', name: 'fecharevision', title: 'Fecha Revisión', header_align: 'text-center', body_align: 'text-center', input: false, width: '10%' },
      { type: 'text', name: 'aprobador', title: 'Firma', header_align: 'text-center', body_align: 'text-center', input: false, width: '10%' },
      { type: 'text', name: 'radicado', title: 'Radicado Solicitud', header_align: 'text-center', body_align: 'text-center', input: false, width: '10%' },
      { type: 'text', name: 'radicadohijo', title: 'Radicado Respuesta', header_align: 'text-center', body_align: 'text-center', input: false, width: '10%' },
      { type: 'text', name: 'radicado_inspeccion', title: 'Radicado Remisorio', header_align: 'text-center', body_align: 'text-center', input: false, width: '10%' },
      { type: 'text', name: 'infraccion1', title: 'Infracción 1', header_align: 'text-center', body_align: 'text-center', input: false, width: '10%' },
      { type: 'text', name: 'infraccion2', title: 'Infracción 2', header_align: 'text-center', body_align: 'text-center', input: false, width: '10%' },
      { type: 'text', name: 'infraccion3', title: 'Infracción 3', header_align: 'text-center', body_align: 'text-center', input: false, width: '10%' },
      { type: 'text', name: 'infraccion4', title: 'Infracción 4', header_align: 'text-center', body_align: 'text-center', input: false, width: '10%' },
      { type: 'text', name: 'infraccion4', title: 'Infracción 5', header_align: 'text-center', body_align: 'text-center', input: false, width: '10%' },
    ...
    $scope.actualizarDatos = function () {
      ...
      $http.get(root + 'controlurbano/reports/reportetotal', { params: params })
    ...
    $scope.exportTableToExcel = function(tableID, filename) {
      ...
      var tableHTML = tableSelect.outerHTML.trim(); // Obtener el HTML de la tabla sin modificar
